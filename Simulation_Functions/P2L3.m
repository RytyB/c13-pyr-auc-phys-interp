...
if fdv.verbose
    ...
    nexttile;
    plot(fdv.taxis(1:fdv.NSeg:end),Mzev(1,:),'g-',...
        fdv.taxis(1:fdv.NSeg:end),Mzev(3,:),'g:',...
        fdv.taxis(1:fdv.NSeg:end),Mzev(2,:),'b-',...
        fdv.taxis(1:fdv.NSeg:end),Mzev(4,:),'b:')
    legend('PyrEV','LacEV','PyrIC','LacIC')
    grid on

    nexttile;
    plot(fdv.taxis(1:fdv.NSeg:end),Mziv(1,:), 'g-',...
        fdv.taxis(1:fdv.NSeg:end),Mziv(2,:), 'b-');
    legend('PyrIV', 'LacIV');
    grid on;
end    